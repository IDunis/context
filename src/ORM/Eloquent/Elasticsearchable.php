...
trait Elasticsearchable
{
    ...
    public function newCollection(array $models = array())
    {
        ...
        $collection->setIndexConnection($this->getIndexConnection());
    ...
    public function getIndexName(): string
    {
        ...
        $name = $this->indexName ?? (new \ReflectionClass($this))->getShortName();
        return "{$env}_{$name}";
    }
    ...
    public static function hydrateElasticsearchResult(array $result)
    {
        ...
        return static::hydrateElasticsearchModelResult($items, $meta = $result);
    }
     ...
     * @return ResultCollection
     */
    public static function hydrateElasticsearchModelResult(array $items, $meta = null)
    {
        $instance = new static;
